...
/*exports.smsg = (conn, m, hasParent) => {
    ...
    m.reply = async (text, chatId, options) => {
        ...
        conn.reply(chatId ? chatId : m.chat, text, m, { contextInfo: { mentionedJid: conn.parseMention(text), externalAdReply: { title: 'Meiichanj - Kemii Denpai', body: 'Simple Bot Menu By Kemii Sazumi', sourceUrl: 'https://chat.whatsapp.com/EHvO9j6JMHb9roHNTvtbdy', thumbnail: data }}, options })
    }
    m.name = m.pushName || conn.getName(m.sender)
